...
En este trabajo nos centraremos principalmente en las imágenes ADF y en los patrones de difracción. Ambos grupos de datos en conjunto serán los que nos aporten la información necesaria para identifica y cuantificar los defectos presentes en una red cristalina.\\
...
\begin{itemize}
    \item Estudiar la relevancia de la inteligencia artificial y las herramientas estadísticas para el tratamiento de datos dentro del campo de la microscopía electrónica. % Cumplido
    ...
    \item Diseñar una red neuronal capaz de clasificar las columnas atómicas y detectar defectos puntuales presentes en una imagen ADF. % Cumplido (falta lo de los defectos, 4) 
